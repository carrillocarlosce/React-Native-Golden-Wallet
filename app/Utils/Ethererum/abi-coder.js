...
var utils = (function () {
  ...
  return {
    defineProperty: require('./properties').defineProperty,

    arrayify: convert.arrayify,
    padZeros: convert.padZeros,

    bigNumberify: require('./bignumber').bigNumberify,
  ...
  return {
    ...
    encode: function (value) {
      try {
        ...
        throwError('invalid number value', errors.INVALID_ARGUMENT, {
          arg: localName,
          type: typeof (value),
          value: value
        });
    ...
    decode: function (data, offset) {
      if (data.length < offset + 32) {
        throwError('insufficient data for ' + name + ' type', errors.INVALID_ARGUMENT, {
          arg: localName,
          coderType: name,
    ...
    decode: function (data, offset) {
      try {
        ...
        if (error.reason === 'insufficient data for uint256 type') {
          throwError('insufficient data for boolean type', errors.INVALID_ARGUMENT, {
            arg: localName,
            coderType: 'boolean',
            value: error.value
          });
  ...
  return {
    ...
    encode: function (value) {
      try {
        ...
        throwError('invalid ' + name + ' value', errors.INVALID_ARGUMENT, {
          arg: localName,
          type: typeof (value),
          value: error.value
        });
  ...
  return {
    ...
    encode: function (value) {
      try {
        ...
        throwError('invalid address', errors.INVALID_ARGUMENT, {
          arg: localName,
          type: typeof (value),
          value: value
        });
    ...
    decode: function (data, offset) {
      if (data.length < offset + 32) {
        throwError('insufficuent data for address type', errors.INVALID_ARGUMENT, {
          arg: localName,
          coderType: 'address',
          value: utils.hexlify(data.slice(offset, offset + 32))
        });
...
function _decodeDynamicBytes(data, offset, localName) {
  if (data.length < offset + 32) {
    throwError('insufficient data for dynamicBytes length', errors.INVALID_ARGUMENT, {
      arg: localName,
  ...
  try {
    ...
    throwError('dynamic bytes count too large', errors.INVALID_ARGUMENT, {
      arg: localName,
      coderType: 'dynamicBytes',
  ...
  if (data.length < offset + 32 + length) {
    throwError('insufficient data for dynamicBytes type', errors.INVALID_ARGUMENT, {
      arg: localName,
      coderType: 'dynamicBytes',
  ...
  return {
    ...
    encode: function (value) {
      try {
        ...
        throwError('invalid bytes value', errors.INVALID_ARGUMENT, {
          arg: localName,
          type: typeof (value),
          value: error.value
        });
  ...
  return {
    ...
    encode: function (value) {
      if (typeof (value) !== 'string') {
        throwError('invalid string value', errors.INVALID_ARGUMENT, {
          arg: localName,
          type: typeof (value),
          value: value
        });
...
function pack(coders, values) {
  ...
  if (Array.isArray(values)) {
    ...
    throwError('invalid tuple value', errors.INVALID_ARGUMENT, {
      coderType: 'tuple',
      type: typeof (values),
      value: values
    });
  ...
  if (coders.length !== values.length) {
    throwError('types/value length mismatch', errors.INVALID_ARGUMENT, {
      coderType: 'tuple',
      value: values
    });
  }
  ...
  return {
    ...
    encode: function (value) {
      if (!Array.isArray(value)) {
        throwError('expected array value', errors.INVALID_ARGUMENT, {
          arg: localName,
          coderType: 'array',
          type: typeof (value),
          value: value
    ...
    decode: function (data, offset) {
      ...
      if (count === -1) {
        try {
          ...
          throwError('insufficient data for dynamic array length', errors.INVALID_ARGUMENT, {
            arg: localName,
            coderType: 'array',
            value: error.value
          });
        ...
        try {
          ...
          throwError('array count too large', errors.INVALID_ARGUMENT, {
            arg: localName,
            coderType: 'array',
...
function getParamCoder(coerceFunc, type, localName) {
  ...
  if (match) {
    ...
    if (size === 0 || size > 256 || (size % 8) !== 0) {
      throwError('invalid ' + match[1] + ' bit length', errors.INVALID_ARGUMENT, {
        arg: 'type',
        value: type
      });
    }
  ...
  if (match) {
    ...
    if (size === 0 || size > 32) {
      throwError('invalid bytes length', errors.INVALID_ARGUMENT, {
        arg: 'type',
        value: type
      });
    }
  ...
  throwError('invalid type', errors.INVALID_ARGUMENT, {
    arg: 'type',
    value: type
  });
}
...
utils.defineProperty(Coder.prototype, 'encode', function (names, types, values) {
  ...
  if (types.length !== values.length) {
    throwError('types/values length mismatch', errors.INVALID_ARGUMENT, {
  ...
  if (names && names.length != types.length) {
    throwError('names/types length mismatch', errors.INVALID_ARGUMENT, {
